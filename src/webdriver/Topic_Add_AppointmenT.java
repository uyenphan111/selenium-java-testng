...
@Test
public class Topic_Add_AppointmenT {
	WebDriver driver;
	...
	String permanentAddress, mofNo, mofDate, agenttype, introducer;
	...
	public void TC_01() {
		...
		driver.findElement(By.xpath("//p[text()='Distribution Management']")).click();
		...
		selectItemInDropdown("div#agentType", "div#react-select-2-listbox div[role='option']", agenttype);
		...
		enterAndSelectInDropDownXpath("//input[@name='introAgentCode']/preceding-sibling::div//input", "//div[@role='listbox']/div[@role='option']", introducer);
